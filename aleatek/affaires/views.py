...
from .serializers import PlanAffaireSerializer, PlanDetailSerializer
...
class PlanAffaireAdminViewsetAdmin(MultipleSerializerMixin, ModelViewSet):
    ...
    detail_serializer_class = PlanDetailSerializer
    queryset = PlanAffaireCreation.objects.all()
